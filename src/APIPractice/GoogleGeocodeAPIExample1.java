...
public class GoogleGeocodeAPIExample1 {
    public static void main(String [] args)
    {
        ...
        try
        {
            ...
            for (int i=0; i < jsonarr_1.size(); i++)
            {
                ...
                System.out.println("formatted address is " + jsonobj_1.get("formatted_address"));

                JSONObject JO_geometry = (JSONObject)jsonobj_1.get("geometry");
                String locationType = (String)JO_geometry.get("location_type");
                ...
                for (int j=0; j < jsonarr_2.size(); j++)
                {
                    ...
                    System.out.println("long name is " + str_data1);
                    String str_data2 = (String) jsonobj_2.get("short_name");
                    System.out.println("short name is " + str_data2);
                    System.out.println("type is " + jsonobj_2.get("types"));
                    System.out.println("\n");
                }
